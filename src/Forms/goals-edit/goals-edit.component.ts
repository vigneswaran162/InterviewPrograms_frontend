...
import { GoalsMasterListModel, ProgramMasterModel } from '../Model/ProgramMasterModel';
...
@Component({
  ...
  styleUrl: './goals-edit.component.css'
})
export class GoalsEditComponent {
model: GoalsMasterListModel
  ...
  async ngOnInit() {
    this.model = new GoalsMasterListModel();
  ...
  preparemodel() {
    const mod = new GoalsMasterListModel();
    mod.GoalName = this.model.GoalName;
    mod.Description = this.model.Description;
    mod.Status = this.model.Status;
    mod.Progress = this.model.Progress;
  ...
  formvalidation() {
    ...
    if (!this.model.GoalName) {
      this.showToast('Goal Name is required');
      return false;
    }
    ...
    if (!this.model.Description) {
      ...
      this.showToast('Progress is required');
      return false;
    }
      if (!this.model.Status) {
      this.showToast('Status is required');
      return false;
    }
    return true;
  }
